...
const iconPaths: Record<IconName, string> = {
    ...
    photo_camera: "M12 12c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm9-5h-3.2l-1.4-1.4c-.4-.4-.8-.6-1.4-.6H7.8c-.6 0-1 .2-1.4.6L5.2 7H2c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zm-10 10c-2.7 0-5-2.3-5-5s2.3-5 5-5 5 2.3 5 5-2.3 5-5 5z",
    route: "M9 3L5 6.99h3V14H6l4 4 4-4h-2V6.99h3L9 3zm7 14.01V10h2v7.01h-2zM12 8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z",
    ...
    menu_open: "M3 18h3.17L4.41 27 3 25.59 9.59 19H3v-2h6.59L14.59 8.41 16 10l-8 8zm12-12h2v2h-2v-2zm0 4h2v2h-2v-2zm0-8h2v2h-2V2zm0 4h2v2h-2V6z",
    trending_up: "M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z",
    flight_takeoff: "M2.5 19h19v2h-19v-2zm19.57-9.36c-.21-.8-1.04-1.28-1.84-1.06L14.92 10l-6.9-6.43-1.93.51 4.14 7.17-4.97 1.33-1.97-1.54-1.45.39 2.59 4.49s7.12-1.9 16.57-1.15c.12-.39-.02-.83-.38-1.05z",
    flight_land: "M2.5 19h19v2h-19v-2zm17.57-9.36c-.21-.8-1.04-1.28-1.84-1.06l-5.31 1.42 4.15 7.17 1.35-.36-1.97-5.44-4.13.72-1.25-.33 2.59-4.49s7.12-1.9 16.57-1.15c.12-.39-.02-.83-.38-1.05zM9.38 11.2l3.12 5.43 3.33-1.3 1.02 1.82-4.78 1.87V17h2v2H2v-2h2v-3.3l4.05-1.59-2.67-4.91z",
